 ...
 const {id}=useParams();
  ...
  return (
    <div>
      ...
      <div className="fixed flex md:border-r-2 md:border-[#ce367c] min-h-screen justify-start  md:justify-center py-14 w-full md:w-fit text-white ">
        <ul className="hidden md:flex md:flex-col">
          <li>
            <Link to={`/wardendashboard/${id}` }>
          ...
          <li>
           ...
           <Link to="studentList" >
             <H2 theme='hover'>Student List</H2>
           </Link>
         </li>
          <li>
          <Link to="/" >
