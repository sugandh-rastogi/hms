...
const [student,setStudent]=React.useState("")
  ...
  const formik =  useFormik(
    ...
    onSubmit: values => {
      axios.put(`http://localhost:8000/dashboard/${id}`,formik.values)
      .then(res=>{
  ...
  React.useEffect(()=>{ axios.get(`http://localhost:8000/dashboard/${id}`)
  
      .then(res=>{
        
       formik.setValues(res.data.student)
      
      })},[`http://localhost:8000/dashboard/${id}`],[formik.values])
